                ...
                <div className="layout-content-navbar">
                    ...
                    <section>
                        <div className="container-xl">
                            <div className="authentication-wrapper authentication-basic container-p-y w-50 mx-auto">
                    ...
                    <footer className="content-footer footer bg-footer-theme">
                        <div
                            className="container-xxl d-flex flex-wrap justify-content-center py-2 flex-md-row flex-column"
                        >
